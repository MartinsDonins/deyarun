...
const adminMenuItems: AdminMenuItem[] = [
  ...
  },
  {
    ...
    description: 'AI settings for training program generation',
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    label: 'AI Conversation Reports',
    description: 'AI conversation data analysis and management',
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  {
    href: '/admin/ai-usage',
    label: 'AI Resource Usage',
    description: 'ChatGPT/OpenAI usage statistics',
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    label: 'Bug Reports',
    description: 'Manage user reported errors',
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
